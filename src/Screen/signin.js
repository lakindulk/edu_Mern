                                    ...
                                    <div >
                                        <Card style={{ backgroundColor: '#330A6A', border: "2px solid #57B9DD" }}>
                                            <div style={{ paddingTop: '1vh', paddingLeft: '1vh', paddingRight: '1vh', paddingBottom: '1vh' }}>
                                                <Row>
                                                    <Col sm={4}><img src='https://res.cloudinary.com/iplus/image/upload/v1678536815/test/user_izpqdu.png' alt='user' style={{ width: '140%' }} /></Col>
                                                    <Col sm={8}>
                                                        <div style={{ paddingLeft: '1vh', color: '#57B9DD' }}>
                                                            <h5>Join as</h5>
                                                            <h5>Student</h5>
                                                        </div>
                                                    </Col>
