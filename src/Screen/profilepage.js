                ...
                <Col sm={10}>
                    ...
                    <div style={{ paddingLeft: '2vh', paddingTop: '2vh' }}>
                        <p style={{ fontSize: '30px' }}><Image src="https://play-lh.googleusercontent.com/7Ac5TgaL15Ra4bvFVHJKCdJp4qvnL4djZj5bKc6RN-MZjzrvkeHbJytek0NPTSdZcp8" style={{ width: '12%' }} roundedCircle={true} />
                            &nbsp; John Perea</p>
                        <div style={{ paddingTop: '2vh', paddingLeft: '20vh', paddingRight: '30vh' }}>

                            <Card style={{ backgroundColor: '#330A6A' }}>
                                <div style={{ paddingLeft: '2vh', paddingTop: '2vh' }}>
                                ...
                                <div style={{ paddingLeft: '3vh', paddingRight: '3vh', paddingBottom: '4vh', paddingTop: '2vh' }}>
                                    <Form>
                                            ...
                                            <Col sm={9}>
                                                <div style={{ paddingRight: '15vh' }}>
                                                    <Form.Group className="mb-3" controlId="formBasicEmail">
                                                        ...
                                                        <Form.Control style={{ backgroundColor: '#D8B7FA' }} type="password" placeholder="Enter password" />
                                                    </Form.Group>
                                                </div>
                                            </Col>
                                            ...
                                            <Col sm={9}>
                                                <div style={{ paddingRight: '15vh' }}>
                                                    <Form.Group className="mb-3" controlId="formBasicEmail">
                                                        ...
                                                        <Form.Control style={{ backgroundColor: '#D8B7FA' }} type="password" placeholder="Enter New Password" />
                                                    </Form.Group>
                                                </div>
                                            </Col>
                                            ...
                                            <Col sm={9}>
                                                <div style={{ paddingRight: '15vh' }}>
                                                    <Form.Group className="mb-3" controlId="formBasicEmail">
                                                        ...
                                                        <Form.Control style={{ backgroundColor: '#D8B7FA' }} type="password" placeholder="Confirm Password" />
                                                    </Form.Group>
                                                </div>
                                            </Col>
                                        </Row>
                                        ...
                                        <div style={{ paddingLeft:'40%',paddingTop:'10vh'}}>
                                            <Button style={{backgroundColor: '#8FE5FF',color:'black',paddingLeft:'7vh',paddingRight:'7vh'}} variant="primary" size="lm">
                                                ~ Save ~
                                            </Button>
                                        </div>
